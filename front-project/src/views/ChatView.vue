...
const sys_message_url = "https://bpic.51yuansu.com/pic3/cover/03/59/43/5bd10c8228793_610.jpg?x-oss-process=image/sharpen,100";
...
const handleMessage = (event) => {
  ...
  const recv_message_used = {
    content: data.message,
    isSentByCurrentUser: false
  };
  chatMessages.value.push(recv_message_used);
};
...
const sendMessage = () => {
  ...
  chatMessages.value.push(send_message_used);
